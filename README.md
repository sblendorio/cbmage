...
In particular, the **4th line** (`./cbmage picture.png | cbmwrite`) produces the raw byes (launch it **without "./"** if you run **on Windows**), which are redirected to the printer throw the piped **cbmwrite** command
